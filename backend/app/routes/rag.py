...
from app.errors import ConfigurationError, ValidationError, NotFoundError
...
async def rag_query(
    ...
    if not settings.openai_api_key:
        raise ConfigurationError("OpenAI API", "API key not configured")

    # Validate and sanitize input
    request.question = validate_search_query(request.question)
